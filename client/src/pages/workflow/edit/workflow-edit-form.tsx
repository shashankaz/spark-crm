                    ...
                    {isChecked && (
                      <div className="ml-7 space-y-3">
                        ...
                        {a.id === "add_task" && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <Field className="-space-y-2 sm:col-span-2">
                              <FieldLabel htmlFor={`edit-${a.id}-title`}>
                                Task Title
                              </FieldLabel>
                              <Input
                                id={`edit-${a.id}-title`}
                            ...
                            <Field className="-space-y-2 sm:col-span-2">
                              <FieldLabel htmlFor={`edit-${a.id}-description`}>
                                Description
                              </FieldLabel>
                              <Textarea
                                id={`edit-${a.id}-description`}
                            ...
                            <Field className="-space-y-2">
                              <FieldLabel htmlFor={`edit-${a.id}-priority`}>
                                Priority
                              </FieldLabel>
                              <Select
                                onValueChange={(val) =>
                            ...
                            <Field className="-space-y-2">
                              <FieldLabel htmlFor={`edit-${a.id}-dueDate`}>
                                Due Date
                              </FieldLabel>
                              <Input
                                id={`edit-${a.id}-dueDate`}
                                type="datetime-local"
                                value={
                                  (
                                    watchedActionConfigs?.[a.id] as
                        ...
                        {a.id === "add_task_with_reminder" && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <Field className="-space-y-2 sm:col-span-2">
                              <FieldLabel htmlFor={`edit-${a.id}-reminderAt`}>
                                Reminder Date &amp; Time
                              </FieldLabel>
                              <Input
                                id={`edit-${a.id}-reminderAt`}
                                type="datetime-local"
                                value={
                                  (
                                    watchedActionConfigs?.[a.id] as
