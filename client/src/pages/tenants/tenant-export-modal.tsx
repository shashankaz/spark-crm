...
import { useExportTenants } from "@/hooks";
...
export const TenantExportModal: React.FC<TenantExportModalProps> = ({
  open,
  onOpenChange,
  selectedTenants,
}) => {
  ...
  const { mutate, isPending } = useExportTenants();
  ...
  const handleExportSubmit = () => {
    ...
    mutate(
      {
        tenantIds: selectedTenants.map((tenant) => tenant._id),
