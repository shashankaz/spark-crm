import { UserWelcomeMail } from "../../types/email";
import { FROM_NAME, FROM_EMAIL } from "../constants";

export const userWelcomeMailTemplate = ({
  userEmail,
  userName,
  tempPassword,
}: UserWelcomeMail) => ({
  ...
  to: userEmail,
  subject: "Welcome to Spark CRM — Your Account is Ready",
  html: `
            ...
            <table width="600" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="padding:40px 30px;">
                  <h2 style="margin-top:0;color:#111827;font-size:20px;">Welcome, ${userName}!</h2>
                  ...
                  <div style="margin:20px 0;padding:20px;background:#fef3c7;border-radius:10px;text-align:center;border:1px solid #fde68a;">
                    <p style="margin:0 0 8px;color:#374151;"><strong>Email:</strong> ${userEmail}</p>
