...
export const getTenantDashboardStats = asyncHandler(async (req, res, next) => {
...
export const getAllTenants = asyncHandler(async (req, res, next) => {
...
export const getUsersByTenantId = asyncHandler(async (req, res, next) => {
  const { id } = req.params;
  if (!id) {
    throw new AppError("Tenant ID is required", 400);
  }
...
export const updateTenantById = asyncHandler(async (req, res, next) => {
  const { id } = req.params;
  if (!id) {
    throw new AppError("Tenant ID is required", 400);
  }
...
export const deleteTenantById = asyncHandler(async (req, res, next) => {
  const { id } = req.params;
  if (!id) {
    throw new AppError("Tenant ID is required", 400);
  }
...
export const createUserForTenant = asyncHandler(async (req, res, next) => {
  const { id } = req.params;
  if (!id) {
    throw new AppError("Tenant ID is required", 400);
  }
